...
(defvar nucleus-leader-key "M-m"
  "The leader prefix key, for global commands.")

(defvar nucleus-localleader-key "M-RET"
  "The localleader prefix key, for major-mode specific commands.")

(unbind-key (kbd nucleus-leader-key))
(unbind-key (kbd nucleus-localleader-key))
...
`define-key', `local-set-key' and `global-set-key' depending on
context and plist key flags (and whether evil is loaded or
not). It was designed to make binding multiple keys more concise,
like in vim.
