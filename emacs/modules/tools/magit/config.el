...
(def-package! magit
  ...
  (add-to-list 'nucleus-real-buffer-functions #'+magit-buffer-p nil #'eq)
  ...
  (when nucleus-leader-key
    (define-key magit-diff-mode-map (kbd nucleus-leader-key) nil)))
...
(def-package! magit-todos
  ...
  (advice-add #'magit-todos-mode :around #'nucleus*shut-up))
...
(def-package! magithub
  ...
  (setq magithub-dir (concat nucleus-etc-dir "magithub/"))
  :init
