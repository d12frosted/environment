...
(def-package! elfeed
  ...
  (setq elfeed-search-filter "@2-week-ago "
        elfeed-db-directory (concat nucleus-local-dir "elfeed/db/")
        elfeed-enclosure-default-dir (concat nucleus-local-dir "elfeed/enclosures/")
  ...
  (add-to-list 'nucleus-real-buffer-functions #'+rss-buffer-p nil #'eq)
