...
(def-package! twittering-mode
  :commands twit
  :config
  (setq twittering-private-info-file (expand-file-name "twittering-mode.gpg" nucleus-etc-dir)
        twittering-use-master-password t
        twittering-request-confirmation-on-posting t
        ;; twittering-icon-mode t
        ;; twittering-use-icon-storage t
        ;; twittering-icon-storage-file (concat nucleus-cache-dir "twittering-mode-icons.gz")
...
"
  ...
  (add-hook 'nucleus-real-buffer-functions #'+twitter-buffer-p)
  ...
  (cond ((featurep! :ui nucleus-modeline +new)
         (setq-hook! 'twittering-mode-hook mode-line-format-right nil))
        ((featurep! :ui nucleus-modeline)
         (def-modeline! 'twitter
           '(bar matches " %b " selection-info)
           '())
         (add-hook! 'twittering-mode-hook (nucleus-set-modeline 'twitter))))
