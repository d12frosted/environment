...
;; `help-mode'
(after! help-mode
  (defun nucleus--switch-from-popup (location)
  ...
  (define-button-type 'help-function-def
    ...
    (lambda (fun file)
      ...
      (nucleus--switch-from-popup (find-function-search-for-symbol fun nil file))))
  ...
  (define-button-type 'help-variable-def
    ...
    (lambda (var &optional file)
      ...
      (nucleus--switch-from-popup (find-variable-noselect var file))))
  ...
  (define-button-type 'help-face-def
    ...
    (lambda (fun file)
      (require 'find-func)
      (nucleus--switch-from-popup (find-function-search-for-symbol fun 'defface file)))))
...
;; `multi-term'
(setq multi-term-buffer-name "nucleus terminal")
...
(progn
  ...
  (defun nucleus*ignore-window-parameters (orig-fn &rest args)
    ...
    (cl-letf (((symbol-function #'windmove-find-other-window)
      ...
      (apply orig-fn args)))
  (advice-add #'windmove-up :around #'nucleus*ignore-window-parameters)
  (advice-add #'windmove-down :around #'nucleus*ignore-window-parameters)
  (advice-add #'windmove-left :around #'nucleus*ignore-window-parameters)
  (advice-add #'windmove-right :around #'nucleus*ignore-window-parameters))
