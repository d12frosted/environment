...
`nucleus-escape-hook' hooks."
    (when git-gutter-mode
      (ignore (git-gutter))))
  (add-hook 'nucleus-escape-hook #'+version-control|update-git-gutter t)
...
;;       (add-hook! '(nucleus-escape-hook focus-in-hook) #'diff-hl-update)
;;     (diff-hl-flydiff-mode +1)
;;     (add-hook! '(nucleus-escape-hook focus-in-hook) #'diff-hl-flydiff-update)
