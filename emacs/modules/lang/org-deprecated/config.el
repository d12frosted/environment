...
(add-hook! 'org-mode-hook
  #'(nucleus|disable-line-numbers  ; org doesn't really need em
     ...
     nucleus|disable-show-paren-mode
...
(defun +org|setup-custom-links ()
  ...
  (setq org-link-abbrev-alist
        '(("github"      . "https://github.com/%s")
          ...
          ("nucleus-repo"   . "https://github.com/hlissner/nucleus-emacs/%s")))
  ...
  (def-org-file-link! "nucleus" nucleus-emacs-dir)
  (def-org-file-link! "nucleus-docs" nucleus-docs-dir)
  (def-org-file-link! "nucleus-modules" nucleus-modules-dir))
...
(defun +org|setup-ui ()
  ...
  (setq-default
   ...
   org-preview-latex-image-directory (concat nucleus-cache-dir "org-latex/")
   org-format-latex-options (plist-put org-format-latex-options :scale 1.5))

  ;; Don't do automatic indent detection in org files
  (add-to-list 'nucleus-detect-indentation-excluded-modes 'org-mode nil #'eq)
    ...
    (setq-default
     ...
     (plist-put org-format-latex-options
                ...
                (face-attribute (or (cadr (assq 'default face-remapping-alist))
                                    'default)
                                :background nil t))))
  (add-hook 'nucleus-load-theme-hook #'+org|update-latex-preview-background-color))

(defun +org|setup-keybinds ()
  "Sets up org-mode and evil keybindings. Tries to fix the idiosyncrasies
between the two."
  (add-hook 'nucleus-escape-hook #'+org|remove-occur-highlights)

  ;; C-a & C-e act like `nucleus/backward-to-bol-or-indent' and
  ;; `nucleus/forward-to-last-non-comment-or-eol', but with more org awareness.
  ...
  (add-hook 'nucleus-delete-backward-functions #'+org|delete-backward-char-and-realign-table-maybe)

  (define-key! org-mode-map
    (kbd "C-c C-S-l") #'+org/remove-link
    (kbd "C-c C-i")   #'org-toggle-inline-images
    [remap nucleus/backward-to-bol-or-indent]          #'org-beginning-of-line
    [remap nucleus/forward-to-last-non-comment-or-eol] #'org-end-of-line))
