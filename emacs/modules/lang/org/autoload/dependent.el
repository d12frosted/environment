;;; lang/org/autoload/dependent.el -*- lexical-binding: t; -*-
;;
...
;;;###autoload
(defun org-edna-action/update-status! (last-entry)
  "Action for org-edna that updates status of found entries.

Status is updated using `+org-dep/update-status'."
  (+org-dep/update-status))
