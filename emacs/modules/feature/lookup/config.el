...
(def-package! dumb-jump
  ...
  :config
  (setq dumb-jump-default-project nucleus-emacs-dir
...
(def-package! helm-dash
  ...
  :defer t
  :init
  (setq helm-dash-enable-debugging nucleus-debug-mode
        helm-dash-browser-func #'eww)
  :config
  (unless (file-directory-p helm-dash-docsets-path)
    (setq helm-dash-docsets-path (concat nucleus-etc-dir "docsets/")))
  (unless (file-directory-p helm-dash-docsets-path)
