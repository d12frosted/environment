...
(+leader-def
  ...
  "M-1" '(+workspace/switch-to 1 :which-key "Switch to 1st workspace")
  "M-2" '(+workspace/switch-to 2 :which-key "Switch to 2nd workspace")
  "M-3" '(+workspace/switch-to 3 :which-key "Switch to 3th workspace")
  "M-4" '(+workspace/switch-to 4 :which-key "Switch to 4th workspace")
  "M-5" '(+workspace/switch-to 5 :which-key "Switch to 5th workspace")
  "M-6" '(+workspace/switch-to 6 :which-key "Switch to 6th workspace")
  "M-7" '(+workspace/switch-to 7 :which-key "Switch to 7th workspace")
  "M-8" '(+workspace/switch-to 8 :which-key "Switch to 8th workspace")
  "M-9" '(+workspace/switch-to 9 :which-key "Switch to 9th workspace")
  ...
  "TAB 1" '(+workspace/switch-to 1 :which-key "Switch to 1st workspace")
  "TAB 2" '(+workspace/switch-to 2 :which-key "Switch to 2nd workspace")
  "TAB 3" '(+workspace/switch-to 3 :which-key "Switch to 3rd workspace")
  "TAB 4" '(+workspace/switch-to 4 :which-key "Switch to 4th workspace")
  "TAB 5" '(+workspace/switch-to 5 :which-key "Switch to 5th workspace")
  "TAB 6" '(+workspace/switch-to 6 :which-key "Switch to 6th workspace")
  "TAB 7" '(+workspace/switch-to 7 :which-key "Switch to 7th workspace")
  "TAB 8" '(+workspace/switch-to 8 :which-key "Switch to 8th workspace")
  "TAB 9" '(+workspace/switch-to 9 :which-key "Switch to 9th workspace")
