...
(map! [remap evil-jump-to-tag] #'projectile-find-tag
      ...
      :nmvo nucleus-leader-key nil
      :nmvo nucleus-localleader-key nil
      ...
      (:after evil
        ...
        (:map evil-window-map ; prefix "C-w"
          ...
          "C-u"     #'winner-undo
          "C-r"     #'winner-redo
          "o"       #'nucleus/window-enlargen
          "O"       #'nucleus/window-zoom
          ;; Delete window
...
(map! :leader
      ...
      :desc "Pop up scratch buffer"   :nv "x"  #'nucleus/open-scratch-buffer
      ...
      (:desc "workspace" :prefix [tab]
        ...
        :desc "Kill all buffers"         :n "x"   #'nucleus/kill-all-buffers
      ...
      (:desc "buffer" :prefix "b"
        ...
        :desc "Kill other buffers"      :n "o" #'nucleus/kill-other-buffers
        :desc "Toggle narrowing"        :nv "-" #'nucleus/clone-and-narrow-buffer
        ...
        :desc "Pop scratch buffer"      :n "x" #'nucleus/open-scratch-buffer
        :desc "Bury buffer"             :n "z" #'bury-buffer
        :desc "Sudo edit this file"     :n "S" #'nucleus/sudo-this-file)
      ...
      (:desc "file" :prefix "f"
        ...
        :desc "Sudo find file"            :n ">" #'nucleus/sudo-find-file
        ...
        :desc "Delete this file"            :n "X" #'nucleus/delete-this-file)
      ...
      (:desc "help" :prefix "h"
        ...
        :desc "Open Bug Report"       :n  "b" #'nucleus/open-bug-report
        :desc "Describe char"         :n  "c" #'describe-char
        :desc "Describe DOOM module"  :n  "d" #'nucleus/describe-module
        :desc "Open Doom manual"      :n  "D" #'nucleus/open-manual
        :desc "Open vanilla sandbox"  :n  "E" #'nucleus/open-vanilla-sandbox
        ...
        :desc "Toggle profiler"       :n  "p" #'nucleus/toggle-profiler
        :desc "Reload theme"          :n  "r" #'nucleus/reload-theme
        :desc "Reload private config" :n  "R" #'nucleus/reload
        :desc "Describe DOOM setting" :n  "s" #'nucleus/describe-setters
        :desc "Describe variable"     :n  "v" #'describe-variable
        :desc "Print Doom version"    :n  "V" #'nucleus/version
        :desc "Man pages"             :n  "w" #'+default/man-or-woman
        :desc "Describe at point"     :n  "." #'helpful-at-point
        :desc "What face"             :n  "'" #'nucleus/what-face
        :desc "What minor modes"      :n  ";" #'nucleus/describe-active-minor-mode)
      ...
      (:desc "toggle" :prefix "t"
        ...
        :desc "Line numbers"           :n "l" #'nucleus/toggle-line-numbers
        :desc "Frame fullscreen"       :n "F" #'toggle-frame-fullscreen
        :desc "Indent guides"          :n "i" #'highlight-indentation-mode
        :desc "Indent guides (column)" :n "I" #'highlight-indentation-current-column-mode
        :desc "Impatient mode"         :n "h" #'+impatient-mode/toggle
        :desc "Big mode"               :n "b" #'nucleus-big-font-mode
...
(define-key universal-argument-map
  (kbd (concat nucleus-leader-key " u")) #'universal-argument-more)
...
(when (featurep! :feature evil +everywhere)
  (evil-define-key* 'insert 'global
    ...
    ;; eol.
    "\C-a" #'nucleus/backward-to-bol-or-indent
    "\C-e" #'nucleus/forward-to-last-non-comment-or-eol
    "\C-u" #'nucleus/backward-kill-to-bol-and-indent
    ...
    [M-backspace] #'nucleus/backward-kill-to-bol-and-indent)
...
(setq evil-collection-key-blacklist
      (list "C-j" "C-k" "gd" "gf" "K" "[" "]" "gz"
            nucleus-leader-key nucleus-localleader-key))
