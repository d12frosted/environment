...
reference for your own private modules. You'll find [[https://github.com/hlissner/nucleus-emacs-private][my private module in a
separate repo]].

Refer to the [[https://github.com/hlissner/nucleus-emacs/wiki/Customization][Customization page]] on the wiki for details on starting your own
private module.
#+end_quote
