...
(defvar d12frosted-omnisharp-pre-extensions
  '(
    ;; pre extension d12frosted-omnisharps go here
    )
  "List of all extensions to load before the packages.")

(defvar d12frosted-omnisharp-post-extensions
  '(
    ;; post extension d12frosted-omnisharps go here
    )
  "List of all extensions to load after the packages.")

;; For each extension, define a function d12frosted-omnisharp/init-<extension-d12frosted-omnisharp>
;;
