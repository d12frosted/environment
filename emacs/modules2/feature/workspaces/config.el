...
(defvar +workspaces-switch-project-function #'nucleus-project-find-file
...
Uses `+workspaces-main' to determine the name of the main workspace."
  ...
  (add-hook 'nucleus-post-init-hook #'+workspaces|init t)
  :config
  (setq persp-autokill-buffer-on-remove 'kill-weak
        persp-nil-hidden t
        persp-auto-save-fname "autosave"
        persp-save-dir (concat nucleus-etc-dir "workspaces/")
  ...
  (add-hook 'nucleus-cleanup-hook #'+workspaces|cleanup-unassociated-buffers)

  ;; Ensure buffers we've opened/switched to are auto-added to the current
  ;; perspective
  (setq persp-add-buffer-on-find-file t
        persp-add-buffer-on-after-change-major-mode t)
  (add-hook 'persp-add-buffer-on-after-change-major-mode-filter-functions #'nucleus-unreal-buffer-p)
  ...
  (defun +workspaces|init-persp-mode ()
    (cond (persp-mode
           ...
           (advice-add #'nucleus-buffer-list :override #'+workspace-buffer-list))
          ((advice-remove #'nucleus-buffer-list #'+workspace-buffer-list))))
