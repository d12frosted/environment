...
(defvar +wakatime-home (concat nucleus-cache-dir "wakatime/")
...
;;;###autoload
(add-hook 'nucleus-post-init-hook #'+wakatime|delayed-autostart)
...
warning)."
  ...
  (if (not wakatime-api-key)
    ...
    (global-wakatime-mode +1))
  ;;
  (remove-hook 'nucleus-exit-buffer-hook #'+wakatime|autostart)
...
open a file."
  (add-hook 'nucleus-exit-buffer-hook #'+wakatime|autostart)
