...
(cfw:face-header             :foreground (nucleus-blend blue bg 0.8) :bold bold)
(cfw:face-sunday             :foreground (nucleus-blend red bg 0.8)  :bold bold)
(cfw:face-saturday           :foreground (nucleus-blend red bg 0.8)  :bold bold)
