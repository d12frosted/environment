...
(def-package! evil-mc
  ...
  (dolist (fn '(nucleus/backward-to-bol-or-indent nucleus/forward-to-last-non-comment-or-eol
                nucleus/backward-kill-to-bol-and-indent delete-char))
  ...
  (defun +multiple-cursors|escape-multiple-cursors ()
    ...
    (when (evil-mc-has-cursors-p)
      ...
      t))
  (add-hook 'nucleus-escape-hook #'+multiple-cursors|escape-multiple-cursors)
