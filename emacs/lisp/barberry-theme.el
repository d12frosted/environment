...
(let* ((height (face-attribute 'barberry-theme-face-default :height nil t))
  ...
  (custom-theme-set-faces
   ...
   '(font-lock-string-face        ((t (:inherit barberry-theme-face-faded))))
   '(font-lock-constant-face      ((t (:inherit barberry-theme-face-salient))))
   '(font-lock-warning-face       ((t (:inherit barberry-theme-face-popout))))
   '(font-lock-function-name-face ((t (:inherit barberry-theme-face-strong))))
   '(font-lock-variable-name-face ((t (:inherit barberry-theme-face-strong barberry-theme-face-salient))))
